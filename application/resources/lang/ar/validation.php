...
return [
    ...
    */
    ...
    'alpha'                => ':attribute يجب إدخال أحرف فقط.',
    ...
    'required'             => ':attribute لايمكن أن يكون فارغ.',
    ...
    */
    ...
    'custom' => [
        'media' => [
            'min_media' => 'العدد الادنى من :type يجب ان يكون :min',
            'not_exist'=>'الملف :file غير موجود على السرفر رجاء اعد اضافته',
            'image'=>'الصور',
            'video'=>'الفديوهات',
            'documents'=>'المستندات',
        ],
